...
IndexDrawingSample::IndexDrawingSample(QWidget* parent)
    : AbstractOpenGLSample(parent) {}

void IndexDrawingSample::paintGL() {
    constexpr size_t  numberOfVertices		   = 4;
    constexpr size_t  numberOfIndicies		   = 6;
    constexpr size_t  numberOfBufferObjects	   = 2;
    ...
    vertices[3] = vec3f(.0, .8, .0);

    GLbyte indicies[numberOfIndicies];
    indicies[0] = 0;
    indicies[1] = 1;
    indicies[2] = 2;
    indicies[3] = 0;
    ...
    GLuint BufferObjects[numberOfBufferObjects];
    glGenBuffers(numberOfBufferObjects, BufferObjects);
...
void main() {
    ...
    glEnableVertexAttribArray(defaultVertexAttribIndex);
    {
        ...
        glVertexAttribPointer(defaultVertexAttribIndex,
                              ...
                              dataSpacing,
                              dataOffset);
        glDrawElements(GL_TRIANGLES, numberOfIndicies, GL_UNSIGNED_BYTE, dataOffset);
    }
    ...
    glDeleteBuffers(numberOfBufferObjects, BufferObjects);
}
