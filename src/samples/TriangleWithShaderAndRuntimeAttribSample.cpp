#include "TriangleWithShaderAndRuntimeAttribSample.h"
...
TriangleWithShaderAndRuntimeAttribSample::TriangleWithShaderAndRuntimeAttribSample(QWidget* parent)
    : AbstractOpenGLSample(parent) {}

void TriangleWithShaderAndRuntimeAttribSample::paintGL() {
...
void main() {
    ...
    GLint vertexAttribIndex = glGetAttribLocation(shaderProgram, "Position");
    glEnableVertexAttribArray(vertexAttribIndex);
    {
        glBindBuffer(GL_ARRAY_BUFFER, VBOs[0]);
        glVertexAttribPointer(
            vertexAttribIndex, numberOfDataComponents, GL_FLOAT, GL_FALSE, dataSpacing, dataOffset);
